...
gulp.task('watch:dist', () => {
  gulp.watch(`${global.config.root + global.config.js.src}**/*.js`, ['js'])
  gulp.watch(`${global.config.root + global.config.css.src}**/*.scss`, ['css'])
  gulp.watch(`${global.config.root + global.config.html.src}**/*.pug`, ['html:dist'])
...
gulp.task('watch:dev', () => {
  ...
  gulp.watch(`${global.config.root + global.config.css.src}**/*.scss`, ['css']).on('change', global.bs.reload)
